...
public class HomePage extends Base {
    ...
    @FindBy (xpath = "/html/body/div[2]/div/div/form/div/div[1]/div/div[4]/div/div/input")
    public WebElement dateAppointment;

    @FindBy (xpath = "/html/body/div[1]/div[1]/section/div/div[2]/div/div[2]/div[2]/div/table/tbody/tr[1]/td[8]/a[1]")
    public WebElement dashboardPayButton;
    ...
    public WebElement payMailBox;

    @FindBy (xpath = "/html/body/div[3]/form/div[2]/div/div[4]/div/div[2]/div/div/div/div/div/div/div[1]/input")
    public WebElement patientCardNo;

    @FindBy (xpath = "/html/body/div[3]/form/div[2]/div/div[4]/div/div[2]/div/div/div/div/div/div/div[2]/input")
    public WebElement patientCardED;

    @FindBy (xpath = "/html/body/div[3]/form/div[2]/div/div[4]/div/div[2]/div/div/div/div/div/div/div[3]/input")
    public WebElement patientCardCvc;

    @FindBy (xpath = "/html/body/div[3]/form/div[2]/div/div[4]/div/div[2]/div/div/div/div/div/div/div[4]/input")
    public WebElement patientZipCode;

    @FindBy (xpath = "/html/body/div[3]/form/div[2]/div/div[3]/div/div/div/button/span/span")
    ...
    public WebElement paymentGoToHomeButton;

    @FindBy (xpath = "/html/body/div[1]/div[1]/section/div/div[2]/div/div[1]/h3")
    public WebElement dashboardAppointment;

    @FindBy (xpath = "/html/body/div[2]/div/div/form/div/div[2]/div/div/strong")
    public WebElement slots;

    @FindBy (xpath = "/html/body/div[2]/div/div/div/div/div/div[2]/div/div[1]/div/div[3]/span[2]")
    ...
    public WebElement newPatientNameBox;

    @FindBy (xpath = "/html/body/div[2]/div/div/div/div/div/div[2]/div/div[2]/div/div[3]/div[2]/div/input")
    public WebElement newPatientMailBox;

    @FindBy (xpath = "/html/body/div[2]/div/div/div/div/div/div[2]/div/div[2]/div/div[3]/div[4]/div/input")
    public WebElement newPatientPhoneBox;

    @FindBy (xpath = "/html/body/div[2]/div/div/div/div/div/div[3]/button[1]")
    public WebElement newPatientSubmitButton;
