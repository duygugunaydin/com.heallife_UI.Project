...
public class HomepageStepdefinitions {//
    ...
    public void selectTheSpecialistDoctorShiftAndDate() {
        ...
        homepage.selectDropdownEvening.click();
        ReusableMethods.bekle(2);
        homepage.dateAppointment.sendKeys(Keys.DELETE+ConfigReader.getProperty("patientAppointmentDate"));
        ReusableMethods.bekle(2);
    }
    ...
    public void clickThePayButtonInTheDashboardPage() {
        homepage.dashboardPayButton.click();
        ReusableMethods.bekle(2);
    ...
    public void enterThePaymentDetailsAndClickThePayButton() {
        ...
        Driver.getDriver().switchTo().frame(homepage.paymentIframe);
        homepage.payMailBox.sendKeys(ConfigReader.getProperty("userTempMail"));
        actions.sendKeys(Keys.TAB).perform();
        ReusableMethods.bekle(2);
        actions.sendKeys("4242").sendKeys("4242").sendKeys("4242").sendKeys("4242").perform();
        ReusableMethods.bekle(2);
        actions.sendKeys(Keys.TAB).perform();
        ReusableMethods.bekle(2);
        actions.sendKeys("12").sendKeys("27").perform();
        actions.sendKeys(Keys.TAB).perform();
        ReusableMethods.bekle(2);
        homepage.patientCardCvc.sendKeys("100");
        actions.sendKeys(Keys.TAB).perform();
        ReusableMethods.bekle(2);
        homepage.patientZipCode.sendKeys("10001");
        ReusableMethods.bekle(2);
        homepage.paySubmit.click();
        ReusableMethods.bekle(3);
    }
    ...
    public void verifyThatYourOnlineAppointmentFeesIsSuccessfullySubmittedScriptIsVisible() {
        ...
        ReusableMethods.bekle(2);
        Assert.assertTrue(homepage.paymentSuccess.isDisplayed());
        ReusableMethods.bekle(2);
    }

    @Then("Click the Go To Home Button")
    public void clickTheGoToHomeButton() {
        homepage.paymentGoToHomeButton.click();
        ReusableMethods.bekle(2);
    }
    ...
    public void verifyThatDashboardIsVisible() {
        ...
        Assert.assertTrue(homepage.dashboardAppointment.isDisplayed());
        ReusableMethods.bekle(2);
    }
    ...
    public void enterThePatientNameEmailAndPhoneSelectTheGenderAndSubmit() {
        homepage.newPatientNameBox.sendKeys(ConfigReader.getProperty("newPatientName"));
        homepage.newPatientMailBox.sendKeys(ConfigReader.getProperty("newPatientMail"));
        homepage.newPatientPhoneBox.sendKeys(ConfigReader.getProperty("newPatientPhone"));
        homepage.newPatientSubmitButton.click();
        ReusableMethods.bekle(3);
    }
